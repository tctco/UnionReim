export default {
  ...
  settings: {
    ...
    updateDownloaded: "Update downloaded. It will be installed on quit.",
    updateNotAvailable: "You are on the latest version.",
    updateCheckFailed: "Failed to check for updates.",
    updatePromptTitle: "Update Downloaded",
    updatePromptMessage: "The update has been downloaded. Restart to install now?",
