...
export function ColorPickerPopover(props: {
    ...
    trigger?: ReactNode; // custom trigger element; if omitted, a small button is used
}) {
    const { colorHex, opacity = 1, onConfirm, trigger } = props;
    ...
    return (
        <Popover open={open} trapFocus onOpenChange={(_e, d) => setOpen(!!d.open)}>
            <PopoverTrigger disableButtonEnhancement>{trigger ?? <Button size="small">Color</Button>}</PopoverTrigger>
            <PopoverSurface
                style={{
                        ...
                        >
                            ...
                            <div
                                style={{
                                    ...
                                    background: hsvToRgbaString(preview),
                                }}
                            />
                        </div>
                    </ColorPicker>
